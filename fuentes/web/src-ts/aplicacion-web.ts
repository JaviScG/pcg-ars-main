...
import { CocheSplineHermite } from "./coche-spline-hermite.js"
...
export class AplicacionWeb 
{
   ...
   private async crearObjetosCamaras() 
   {
      ...
      // coche animado siguiendo una spline cúbica de Hermite (con puntos y trayectoria)
      this.objetos.push( new CocheSplineHermite() )
      this.camaras.push( new CamaraOrbital3D() )
